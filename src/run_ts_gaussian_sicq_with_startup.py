...
from bandit_algorithm.thompson_sampling.gaussian_sicq_prior_with_startup import \
    ThompsonSamplingGaussianSicqPriorWithStartup
from utils.data_processing import calc_mean_data


def main():
    parser = argparse.ArgumentParser(
        description='Bandit Experiment of TS-Gaussian-Sicq-Prior-With-Startup')
    ...
    algorithm = ThompsonSamplingGaussianSicqPriorWithStartup(len(arms), args.save_log)
    arm_name = ''
